...
//   const doctors = await detailsFetch(id);
//   const {
//     name,
//     _id,
//     specialty,
...
//         </Link>
//         {/* Header */}
//         <div className="bg-white border rounded-2xl p-8 flex flex-wrap items-center gap-6 mb-4">
//           <div className="">
//             <Image
...
//           <div className="bg-white border rounded-xl p-4 text-center">
//             <h2 className="text-xl font-bold">5.4k</h2>
//             <p className="text-sm text-gray-500">patients</p>
//           </div>

//           <div className="bg-white border rounded-xl p-4 text-center">
//             <h2 className="text-xl font-bold">{fee} Tk</h2>
//             <p className="text-sm text-gray-500">fee</p>
//           </div>
//         </div>

//         {/* About */}
//         <div className="bg-white border rounded-2xl p-8 mb-4">
...
//         {/* CTA */}
//         <div className="bg-[#085041] rounded-2xl p-8 flex flex-wrap items-center justify-between gap-4">
//           <div>
